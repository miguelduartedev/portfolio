  ...
  return (
    <section className={`text-area ${area}`}>
      ...
      >
        ...
        <p>
          {" "}
          I'm a big enjoyer of Geopolitics, Maps, Travel and{" "}
          <a
            style={{ color: "white" }}
        ...
        <p>
          ...
          has deeply shaped who I am today.
        </p>
        ...
        <p>
          {" "}
          When I travel I tend to bring with me a small mirrorless camera, I'm
          far from a photography expert (in fact I take all my photos on
          automatic) but I quite enjoy capturing and sharing these moments on
          social media. 📷
        </p>
        <p>In this page you'll find a slider with some of my best shots.</p>
        <p>
          In the past I've dabbled in music production, creating animations for
          storytelling and pixel art (even won a Habbo Hotel competition once!)
          but none of those stuck around. I also used to produce Gifs and
          Photosets on Tumblr back in the day.
        </p>
        ...
        <p>
          ...
          actually quite tired of the constant beaming sun and heat of Lisbon.
          😅
        </p>
        <p>
          I love places that have bold seasons. You know, the flourishing
          spring, warm summer, cozy fall and snowy winter. I've always wanted to
          move somewhere colder, with a culture that I can relate more to.
        </p>
        <h3 className="text-area-heading mt-5 mb-4">LANGUAGES</h3>
        <p>I only speak two languages fluently: Portuguese and English. </p>
        <p>Although I can easily understand spoken and written Spanish. </p>
        <p>
          Hopefully someday I'll get around learning a new language. I've
          actually always wanted to learn a second Germanic language.
        </p>
        <p>
          ...
          So I just started connecting the images and the words that were
          spoken. I recall that at the age of 6/8 I'd sometimes forget how to
          say certain words in Portuguese but I'd remember the English
        ...
        <p>
          ...
          Portugal's top unicorns. I started off as a Hybrid worker but after
          the pandemic I became a remote worker and I've since become an
          enthusiast in remote work and digital nomad lifestyle.
        </p>
        <p>
