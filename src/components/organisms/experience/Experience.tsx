...
const Experience: FC<Area> = ({ area, setArea }) => {
  ...
  return (
    ...
    >
      <p
        className="text-area-anchor text-start pointer pt-3 margins"
      ...
      <div className="row margins">
        <div className="col-12 col-lg-6">
          ...
          <div className="row skill-container ms-4 ms-sm-0 me-4 me-sm-0">
            ...
            <div className="col-12 col-md-9 col-xl-10 text-start">
              <p className="fw-bold mb-0">Front End Developer @ Talkdesk </p>
          ...
          <div className="row skill-container ms-4 ms-sm-0 me-4 me-sm-0 mt-5">
            ...
            <div className="col-12 col-md-9 col-xl-10 text-start">
              <p className="fw-bold mb-0">Front End Developer @kicker.cloud</p>
              <p className="detail mb-0">Sep 2023 -</p>
              <p className="font-size-08 mb-0">
                Developing software features and solutions (both new and
                existing), including writing, testing, and reviewing
                production-ready code for a start-up focused on improving data
                usage and processes in deal-making.
              </p>
            </div>
          </div>
        </div>
        <div className="col-12 col-lg-5 offset-lg-1 pt-5 pt-lg-0">
          ...
          <a
            href="https://udemy-certificate.s3.amazonaws.com/pdf/UC-052a513f-3141-43bb-8191-f6a516b84807.pdf"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://udemy-certificate.s3.amazonaws.com/pdf/UC-107e2263-8055-4904-94ee-8cddeafb72b8.pdf"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div className="row pt-5 pb-5 margins">
        <h3 className="text-area-heading text-start mb-4 ms-3 ms-sm-0">
          Education
        </h3>
